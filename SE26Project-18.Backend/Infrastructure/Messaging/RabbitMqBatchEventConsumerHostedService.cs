    ...
    where TConsumer : class, IBatchEventConsumer<TEvent>
{
    ...
    private readonly RecommendationVectorStoreReadiness _vectorStoreReadiness;
    ...
    public RabbitMqBatchEventConsumerHostedService(
        ...
        RecommendationVectorStoreReadiness vectorStoreReadiness,
    ...
    )
    {
        ...
        _vectorStoreReadiness = vectorStoreReadiness;
        _logger = logger;
    ...
    {
        await _vectorStoreReadiness.WaitAsync(stoppingToken);
